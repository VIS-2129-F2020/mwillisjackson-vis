...
This projection may make countries in northern Africa and southern Africa appear slightly larger when compared to those closer to the equator.

```{r map new projections}

africa_map +
  geom_sf() +
  coord_sf(crs = africa_lambert) +
  annotation_scale() +
  theme_economist()
...
```{r map transformed}
africa_transformed_lambert<- africa %>%
  st_transform(crs = africa_lambert)
