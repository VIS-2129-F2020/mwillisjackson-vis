...
mbta_bus_stop <- st_read("C:/Users/mwill/OneDrive - Harvard University/2020 - Fall/Spatial Analysis/InteractiveMaps/mbtabus/mbtabus/PT") %>%
  st_transform(crs = leaflet_plane)

mbta_train_route <- st_read("C:/Users/mwill/OneDrive - Harvard University/2020 - Fall/Spatial Analysis/InteractiveMaps/mbta_rapid_transit/ARC") %>%
  st_transform(crs = leaflet_plane)

mbta_train_stop <- st_read("C:/Users/mwill/OneDrive - Harvard University/2020 - Fall/Spatial Analysis/InteractiveMaps/mbta_rapid_transit/NODE") %>%
  st_transform(crs = leaflet_plane)

south_boston <- st_read("C:/Users/mwill/OneDrive - Harvard University/2020 - Fall/Spatial Analysis/InteractiveMaps/SouthBoston_tract") %>%
  st_transform(crs = leaflet_plane)
...
south_boston$describe <- paste(south_boston$NAMELSAD, "<br>",
                               south_boston$num_stops, " bus/train stops", "<br>",
                               prettyNum(south_boston$stop_density*5280, digits = 4), 
